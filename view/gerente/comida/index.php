    ...
    <div class="container-fluid">
      <header class="my-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
          ...
          <a href="adicionar.php" class="d-none d-sm-block btn btn-verde m-0 px-4">Nova Comida</a>
          <a href="adicionar.php" class="d-block d-sm-none btn btn-verde m-0"><img src="../../img/plus.svg" alt="Nova Comida"></a>
        </div>
      </header>
