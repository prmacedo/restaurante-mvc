      ...
      <main>
        <form action="">
          ...
          <div class="form-group col-md-7 px-0">
            ...
            <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome da bebida" required>
          </div>
          
          <div class="form-group col-md-7 px-0">
            <label class="m-0" for="fornecedor">Fornecedor</label>
            <input type="text" class="form-control" id="fornecedor" name="fornecedor" placeholder="Digite o fornecedor da bebida" required>
          </div>

          <div class="form-group col-md-7 px-0">
            <label class="m-0" for="preco">Preço</label>
            <input type="number" class="form-control" id="preco" name="preco" min="0" step=".01" placeholder="Digite o preço da bebida" required>
          </div>
